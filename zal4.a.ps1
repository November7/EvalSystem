...
if(($zsme.bindings.Collection.bindingInformation -like "10.38.*.1:80:zsme.local" | measure).count -eq 1 -and 
   ($zsme.bindings.Collection.bindingInformation -like "10.38.*.1:80:www.zsme.local" | measure).count -eq 1 -and 
   ($zsme.bindings.Collection.bindingInformation -like "10.38.*.1:21:" | measure).count -eq 1) {$tInfo[25].OK()}
...
if(($biblioteka.bindings.Collection.bindingInformation -like "10.38.*.1:80:biblioteka.local" | measure).count -eq 1 -and 
   ($biblioteka.bindings.Collection.bindingInformation -like "10.38.*.1:80:www.biblioteka.local" | measure).count -eq 1) {$tInfo[35].OK()}
...
if(($ftp_pub.bindings.Collection.bindingInformation -like "10.38.*.2:21:" | measure).count -eq 1) {$tInfo[42].OK()}
