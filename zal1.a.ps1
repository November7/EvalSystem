...
$tInfo += New-Object Info("- Wygasanie konta ($USR1LOGIN)",2) #19
...
$tInfo += New-Object Info("- Godziny logowania ($USR2LOGIN)",2) #23
...
if($USR1.AccountExpirationDate -eq "2017-07-01 00:00:00") {$tInfo[19].OK()}
...
if(-not (Compare-Object $USR2.logonHours (0,0,0,0,255,0,0,255,0,0,255,0,0,255,0,0,255,0,0,0,0))) {$tInfo[23].OK()}
