...
" - Interfejs enp0s3:fst dhcp " "checkInt -i enp0s3:jeden" 2
" - Interfejs enp0s3:sec 10.38.$2.22" "checkInt -i enp0s3:dwa -a \"10.38.$2.2\" -m \"255.0.0.0\"" 2
" - Interfejs enp0s3:thrd 10.38.$2.23" "checkInt -i enp0s3:trzy -a \"10.38.$2.3\" -m \"255.0.0.0\"" 2
""
